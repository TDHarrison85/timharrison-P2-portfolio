...
I am going to create sythinetic data using artificail inteligence software. I will have attributes that are received from Experian to simulate a credit report and customer attributes that I would be able to get from a bank.
