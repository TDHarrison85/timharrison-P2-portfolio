...
Adding new code to create boxplot using the new categorical data

```{r}
ggplot(mydata, aes(x = Gender, y = BMI, fill = Gender)) +
  geom_boxplot() +
...
Now creating scatterplot with weight on the x-axis and the new numerical variable on the y-axis

```{r}
ggplot(mydata, aes(x = Weight, y = BMI)) +
  geom_point() +
  labs(title = "Scatterplot of Weight vs. BMI", x = "Weight (kg)", y = "BMI") +
  theme_minimal()
```
